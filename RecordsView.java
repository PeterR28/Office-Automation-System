...
public class RecordsView extends Application {
    ...
    public void start(Stage primaryStage) {
            ...
            if (!search.isEmpty()) {
                ...
                try {
                    ...
                    if (!pInfo.isBlank()) {
                        ...
                        // Retrieve and display new dates for the searched patient
                        dates = Office.getInstance().getVisitDates(id);
                        for (String date : dates) {
                            Button dateButton = new Button("Visit on " + date);
                            listView.getItems().add(dateButton);
                            ...
                            dateButton.setOnAction(event -> {
                                try {
                                    ...
                                    historyArea.setText(ex.toString());
                                }
                            });
                        }
        ...
        // Set the ListView on the left side
